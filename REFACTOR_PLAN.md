...
- [ ] remaining pages > 250 lines: [x] chamadas (→ `useMonitorQueue` + `monitor/{MesaGrid,CurrentCalled,WaitingList}`, completes 3-socket consolidation); [ ] admin/servicos, [ ] instructor/aulas, [ ] admin/alunos/index
